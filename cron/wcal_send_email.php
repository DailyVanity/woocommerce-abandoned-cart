                                        ...
                                        if ( '' != $email_sent_id ) {
                                            ...
                                            if( preg_match( "{{products.cart}}", $email_body, $matched ) ) {
                                                if ( class_exists( 'WP_Better_Emails' ) ) {
                                                    $var = '<table width="100%">
                                                            <tr align="left">
                                                            <th style="padding:0;width:30%;">'.__( "Service", "woocommerce-abandoned-cart" ).'</th>
                                                            <th style="padding:0;width:20%;text-align:center;">'.__( "Qty", "woocommerce-abandoned-cart" ).'</th>
                                                            <th style="padding:0">'.__( "Price", "woocommerce-abandoned-cart" ).'</th>
                                                            <th style="padding:0">'.__( "Subtotal", "woocommerce-abandoned-cart" ).'</th>
                                                            </tr>';
                                                } else {
                                                    $var = '<table width="100%" border="0" cellpadding="10" cellspacing="0" class="templateDataTable">
                                                            <tr align="left">
                                                            <th style="padding:0;width:30%;">'.__( "Service", 'woocommerce-abandoned-cart' ).'</th>
                                                            <th style="padding:0;width:20%;text-align:center;">'.__( "Qty", 'woocommerce-abandoned-cart' ).'</th>
                                                            <th style="padding:0">'.__( "Price", 'woocommerce-abandoned-cart' ).'</th>
                                                ...
                                                foreach ( $cart_details as $k => $v ) {
                                                    ...
                                                    if ( isset( $v->variation_id ) && '' != $v->variation_id ) {
                                                        ...
                                                        if( version_compare( $woocommerce->version, '3.0.0', ">=" ) ) {  
															...
															$product_name = change_promotion_title( "", $v->variation_id );
                                                        }
														
														
                                                        $var .='<tr align="left">
                                                                <td> <a href="'.$cart_link_track.'">'.__( $product_name, 'woocommerce-abandoned-cart' ).'</a></td>
                                                                <td style="text-align:center;"> '.$quantity_total.'</td>
                                                                <td> '.$item_subtotal.'</td>
																...
																// if( $index == 0 ) {
																	...
																	// $var .= '<td rowspan="'. sizeof($cart_details) .'" style="vertical-align:top;"> '.$cart_total.'</td>';
																// }
                                                        $var .= '</tr>';
														$index++;
                                                    }
                                                    ...
                                                    $var .= '<tr align="left">
                                                            <td> </td>
                                                            <td> </td>
                                                            <td><b>'.__( "Cart Total:", 'woocommerce-abandoned-cart' ).'</b></td>
